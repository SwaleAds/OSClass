                        ...
                        <form action="<?php echo osc_base_url(true); ?>" method="get" onSubmit="return checkEmptyCategories()">
                            ...
                            <fieldset class="box show_only">
                                ...
                                <div class="row two_input">
                                    ...
                                    <input type="text" id="priceMin" name="sPriceMin" value="<?php echo osc_search_price_min() ; ?>" size="6" maxlength="10" />
                                    <div><?php _e('Max', 'modern') ; ?>.</div>
                                    <input type="text" id="priceMax" name="sPriceMax" value="<?php echo osc_search_price_max() ; ?>" size="6" maxlength="10" />
                                </div>
                                <?php } ?>
