                    ...
                    <fieldset>
                        ...
                        <input type="hidden" name="secret" value="<?php echo osc_item_secret() ;?>" />
                            ...
                            <div class="box location">
                                ...
                                <div class="row">
                                    <label><?php _e('State', 'modern'); ?></label>
                        ...
                        <div class="clear"></div>
                        <img style="visibility:hidden; padding-top: 10px;" id="progress_image" src="<?php echo osc_current_web_theme_url('images/ajax-loader.gif') ; ?>" alt="">
                        <div class="clear"></div>
                        <button class="itemFormButton" onclick="return loadSubmit()" type="submit"><?php _e('Update', 'modern');?></button>
